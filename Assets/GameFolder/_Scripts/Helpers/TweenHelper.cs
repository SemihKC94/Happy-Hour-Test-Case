...
namespace SKC.Helpers.Tween
{
    public static class TweenHelper
    {
        ...
        {
            item.DOJump(targetPosition, jumpPower, 1, duration).SetEase(Ease.InExpo).SetRecyclable().SetAutoKill();
        ...
        public static void SpendResource(int requiredResource, int collectedResource, int myResource, out DG.Tweening.Tween resourceSpendingTween, float spendingSpeed,
        ...
        public static DG.Tweening.Tween DisappearSlowly(Transform transform, float duration, TweenCallback onCompleted)
        {
